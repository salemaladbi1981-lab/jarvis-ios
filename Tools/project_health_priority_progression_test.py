...
checks = {
    ...
    "owner actions match the three remaining physical-device gates": len(owner_actions) == 3 and "Siri/App Shortcuts" in action_text and "AirPods/Shokz" in action_text and "macOS Accessibility" in action_text,
