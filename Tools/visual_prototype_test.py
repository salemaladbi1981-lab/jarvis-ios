...
check("Core: smoothing attack في onChange", 'Smoothing.attack' in core and 'onChange(of: micLevel)' in core)
...
check("HomeViewModel: micLevel/outputLevel published", 'micLevel' in vm and 'outputLevel' in vm)
