...
class Identity:
    ...
    def __init__(self, user_id: str, session_id: str, conversation_id: str,
        ...
        self.memory_namespace = memory_namespace or f"{MEMORY_NAMESPACE_PREFIX}:{self.user_id}:{self.workspace_id}:{self.conversation_id}"
...
def from_args(args: dict) -> Identity:
    ...
    return Identity(
        ...
        workspace_id=args.get("workspace_id", "") or "PERSONAL",
