...
REALTIME_INSTRUCTIONS = os.environ.get(
    ...
    "لأسئلة جرد الوكلاء أو وجود وكيل أو اسمه أو دوره (مثل «هل عندي معمار؟» أو «من هو المدرب؟») استخدم jarvis_agent_lookup حصراً من الـregistry الرسمي، ولا تجب من ذاكرة النموذج ولا تنفِ وجود وكيل بدون نتيجة الأداة."
)
