...
REALTIME_INSTRUCTIONS = os.environ.get(
    ...
    "لديك أيضاً أدوات خرائط (maps_search, maps_distance, maps_eta, maps_navigate) للبحث عن مكان أو حساب المسافة أو زمن الوصول أو فتح التنقل في تطبيق الخرائط — استدعها عند سؤال المالك عن موقع أو مسافة أو وقت وصول أو تنقل، ولا تخترع إحداثيات أو مسافات أو أزمنة من معرفتك. كل نتيجة تحمل lat/lon أو مسافة/زمن حقيقيين من OpenStreetMap/OSRM. عند طلب تنقل استدع maps_navigate ليفتح الجهاز تطبيق الخرائط."
)
