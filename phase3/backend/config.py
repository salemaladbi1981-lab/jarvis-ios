...
REALTIME_INSTRUCTIONS = os.environ.get(
    ...
    "ولا تملأ الفراغ بتخمين. لديك أدوات بريد إلكتروني (email_summary, email_search, email_read, "
    "email_draft_reply, email_send) — استدعها للإجابة عن أسئلة البريد ولا تخترع أي محتوى بريد من معرفتك. "
